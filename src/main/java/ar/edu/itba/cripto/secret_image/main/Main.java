...
public class Main implements Runnable {
     ...
     */
    @Parameter(names = {"-n"}, description = "Optional. The amount of shadows to be created." +
    ...
    @Parameter(names = {"-dir"}, description = "Optional. The path to the directory containing the shadow images." +
